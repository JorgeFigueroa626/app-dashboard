...
export class UsuariosComponent implements OnInit {
  ...
  constructor(private _usuarioServices: UsuarioService, private _snackBar: MatSnackBar) {}
  ...
  eliminarUsuario(index:number) {
    console.log(index);
    //LAMAMOS AL SERVICIO DEL ELIMINAR USUARIO
    this._usuarioServices.elinminarUsuario(index);
    this.cargarUsuario();
    this._snackBar.open('Eliminacion de usuario exitoso', '', {
      duration: 1500,
